...
return [
    ...
    'OPTIONS v1/projects/<idProject:\d+>/users/<idUser:\d+>/enable'        => 'v1/project-user/enable',
    'GET,HEAD v1/projects/<idProject:\d+>/users/<idUser:\d+>/disable'      => 'v1/project-user/disable',
    'OPTIONS v1/projects/<idProject:\d+>/users/<idUser:\d+>/disable'       => 'v1/project-user/disable',
    'GET,HEAD v1/projects/<idProject:\d+>/users/<idUser:\d+>/switch-state' => 'v1/project-user/switch-state',
    'OPTIONS v1/projects/<idProject:\d+>/users/<idUser:\d+>/switch-state'  => 'v1/project-user/switch-state',
    ...
    'OPTIONS v1/users/<id:\d+>/enable'                                     => 'v1/user/enable',
    'GET,HEAD v1/users/<id:\d+>/disable'                                   => 'v1/user/disable',
    'OPTIONS v1/users/<id:\d+>/disable'                                    => 'v1/user/disable',
    'GET,HEAD v1/users/<id:\d+>/switch-state'                              => 'v1/user/switch-state',
    'OPTIONS v1/users/<id:\d+>/switch-state'                               => 'v1/user/switch-state',
