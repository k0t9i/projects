...
class Rbac extends Model
{
    ...
    public function initRoles()
    {
        ...
        $auth->addChild($performer, $userRoles['ownPermissions']);
        ...
        $auth->addChild($manager, $userRoles['ownPermissions']);
    ...
    /**
     * Create roles and permissions for AccessToken
     * 
    ...
    /**
     * Create roles and permissions for User
     * 
     * @param ManagerInterface $manager
     * @param string $key name of section
     * @param array $rules used auth rules
    ...
    private function initUserRoles(ManagerInterface $manager, $key, array $rules)
    {
        ...
        $ret['permissions']->description = 'View user permissions';
        $manager->add($ret['permissions']);

        $ret['ownPermissions'] = $manager->createPermission($key . '.ownPermissions');
        $ret['ownPermissions']->description = 'View own user permissions';
    ...
    /**
     * Create roles and permissions for Project
     * 
     * @param ManagerInterface $manager
     * @param string $key name of section
     * @param array $rules used auth rules
    ...
    /**
     * Create roles and permissions for UserGroup
     * 
     * @param ManagerInterface $manager
     * @param string $key name of section
     * @param array $rules used auth rules
